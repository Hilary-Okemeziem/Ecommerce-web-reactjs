...
const Advert = () => {
  return (
    <div className='w-full h-[500px] lg:h-[550px] py-16'>
        <div className='bg-fixed md:flex flex-col justify-center items-start w-full h-[60vh] bg-center bg-no-repeat bg-cover advert-img hidden '>
        ...
        <div className='relative md:hidden'>
            ...
            <img src={beach} alt="/" className='w-full h-[60vh] object-cover'/>

            <div className='flex items-center justify-between flex-wrap max-w-[1240px] m-auto p-2 absolute top-0 left-0 w-full h-full'>
                <div>
                    <h1 className='text-3xl pt-10 font-bold text-white'>Get ready for the beach </h1>
                    <p className='text-white text-xl pt-[1rem]'>50% off vacation and beach wears. Offer available while stock lasts</p>
                </div>
                <div>
                    <Link to='/shoppage'>
                        <button className='text-[#2776AA] text-xl group border-2 px-10 py-3 rounded-lg flex items-center bg-[#ffffff] hover:border-[#ffffff] hover:bg-transparent hover:text-white'>
                            Grab Deals <span className='group-hover:rotate-90 duration-300'><HiArrowNarrowRight className='ml-3'/></span>
                        </button>             
                    </Link>
                </div>
