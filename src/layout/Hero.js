    ...
    <div className='bg-[#A1BEC2] w-full'>
            ...
            <div className='flex items-center justify-between z-10'>
                <div>
                    ...
                    <button className='bg-button text-btnText dark:text-white px-5 py-3 mt-4 rounded-lg shadow-lg hover:shadow-2xl cursor-pointer'>
                        <Link to='/' className='cursor-pointer'>SHOP NOW</Link>
                    </button>
                </div>
                <div className='z-10'>
                    <img src={hero} alt="/" />
        ...
        <div className='hero-section pl-5 lg:hidden'>
            <div className='hero-text'>
                ...
                <button className='bg-button text-btnText dark:text-white px-5 py-3 mt-3 rounded-lg shadow-lg hover:shadow-2xl cursor-pointer'>
